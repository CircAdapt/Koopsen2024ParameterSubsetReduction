...
classdef mex_interface < handle
    ...
    methods
        ...
        %% GetPStruct : getP(CA)
        function P = getP(this,varargin)
            P = CircAdaptGetP(this,varargin);
        end
        
        %% SetPStruct : setP(CA)
        function this = setP(this,P)
            this = CircAdaptSetP(this,P);
        end
        %% GetPStruct : getP1(CA)
        function P = getP1(this,varargin)
            P = CircAdaptGetP1(this,varargin);
        end
        
        %% SetPStruct : setP1(CA)
        function this = setP1(this,P)
            this = CircAdaptSetP1(this,P);
        end
        %% All other methods
